...
def get_user_repertoire():
    ...
    moves = repertoire_service.get_repertoire_moves(args['position'], user, args['color'], args['depth'])
...
def edit_user_repertoire():
    ...
    moves = repertoire_service.update_user_repertoire(args['position'], user, args['color'], args['move'])
    if len(moves) == 0:
...
def add_rival_move():
    ...
    moves = repertoire_service.add_rival_move_to_repertoire(args['position'], user, args['color'], args['move'])
...
def remove_rival_move():
    ...
    moves = repertoire_service.remove_rival_move_from_repertoire(args['position'], user, args['color'],
                                                                 args['move'])
